...
// Startup code for the executable 'xmlTest'.
...
LE_SHARED le_log_SessionRef_t xmlTest_exe_LogSession;
LE_SHARED le_log_Level_t* xmlTest_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    xmlTest_exe_LogSession = le_log_RegComponent("xmlTest_exe", &xmlTest_exe_LogLevelFilterPtr);
    ...
    LoadLib("libxml2.so");
    LoadLib("libComponent_xmlTest_Component.so");
